                    ...
                    <Grid item xs={11} sm={11} lg={7}>
                        <Item elevation={6}>
                            <Grid container spacing={1} justifyContent="center">
                                ...
                                {showForm?
                                    <Grid item sm={12} lg={12} xs={12}>
                                        <Button style={{margin: 10}} variant="contained" color="warning" onClick={() => setShowForm(!showForm)}>Cancel</Button>
                                    </Grid>
                                    :
                                    <Grid item sm={12} lg={12} xs={12}>
                                ...
                                {showForm ?
                                    <Grid item sm={12} lg={12} xs={12}>
                                        <EditForm pic={user.photoUrl} displayName={user.displayName} email={user.email} id={user._id}/>
                                    </Grid>
                                    :
                                    null
                                }
